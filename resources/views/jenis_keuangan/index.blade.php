...
@section('content')
    <div class="row">
        <div class="ms-3">
            <h3 class="mb-0 h4 font-weight-bolder">Jenis Keuangan</h3>
        </div>
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div
                        class="bg-gradient-light shadow-secondary border-radius-lg pt-3 pb-1 d-flex justify-content-between align-items-center">
                        ...
                        <div class="pe-3">
                            ...
                            <a href="#" class="btn btn-sm btn-primary text-dark">
